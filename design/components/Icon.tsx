 ...
 * Icon Component
 * 
 * Minimalist SVG icons aligned with NSD brand guidelines.
 * Uses violet color spectrum for consistency.
 */

import { violet, text } from '../tokens/colors';
...
export function Icon({ name, size = 20, color = text.secondary, className }: IconProps) {
