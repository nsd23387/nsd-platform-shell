...
import type { CampaignDetail, ICP, PersonalizationStrategy } from '../../../../../../sales-engine/types/campaign';
import { getCampaign, updateCampaign } from '../../../../../../sales-engine/lib/api';
import { StatusBadge, AICampaignGenerator, ICPEditor, PersonalizationEditor } from '../../../../../../sales-engine/components';
    ...
    return (
      <div style={{ padding: '48px 32px', fontFamily: fontFamily.body }}>
        <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <Link href="/command-center/sales-engine" style={{ color: violet[500], display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
