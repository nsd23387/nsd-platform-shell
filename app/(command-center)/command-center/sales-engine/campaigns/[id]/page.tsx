...
import type { CampaignDetail } from '../../../../../sales-engine/types/campaign';
import { getCampaign, submitCampaign } from '../../../../../sales-engine/lib/api';
...
export default function CampaignDetailPage() {
  ...
  const navLinks: { href: string; label: string; icon: IconName; show: boolean }[] = [
    { href: `${basePath}/edit`, label: 'Edit Campaign', icon: 'edit', show: campaign.canEdit },
    { href: `${basePath}/review`, label: 'Review & Approve', icon: 'review', show: campaign.status === 'PENDING_REVIEW' },
    { href: `${basePath}/metrics`, label: 'Metrics', icon: 'metrics', show: true },
    { href: `${basePath}/runs`, label: 'Run History', icon: 'runs', show: true },
    { href: `${basePath}/variants`, label: 'Variants', icon: 'variants', show: true },
    { href: `${basePath}/safety`, label: 'Safety', icon: 'shield', show: true },
  ];
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div>
                ...
                <p style={{
                  ...
                  Execution is managed externally via NSD Command Center.
                </p>
              </div>
            </div>
          </div>
