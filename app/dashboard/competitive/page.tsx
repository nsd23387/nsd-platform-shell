...
//         (all proxied to nsd-integrations.vercel.app; bearer stays server-side)
    ...
    <div data-testid="page-competitive">
      ...
      {notConfigured && (
        <div style={{ padding: space['4'], backgroundColor: '#fef3c7', border: '1px solid #f59e0b', borderRadius: radius.lg, marginBottom: space['6'], fontFamily: fontFamily.body, fontSize: fontSize.sm, color: '#92400e' }} data-testid="banner-not-configured">
          <strong>Competitive API not configured.</strong> Set <code>API_SECRET_KEY</code> (same value as <code>API_SECRET_KEY</code> in the nsd-integrations Vercel project) to enable competitive intelligence.
        </div>
      )}
